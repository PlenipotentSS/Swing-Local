...
#define DO_BACK_COLOR               [UIColor offWhiteScheme];

// button background color
//#define DO_BUTTON_COLOR             DO_RGB(158, 132, 103)
#define DO_BUTTON_COLOR             [UIColor orangeScheme];
#define DO_CANCEL_COLOR             [UIColor burntScheme];
#define DO_DESTRUCTIVE_COLOR        DO_RGB(124, 192, 134)

// button text color
//#define DO_TITLE_TEXT_COLOR         DO_RGB(95, 74, 50)
#define DO_TITLE_TEXT_COLOR         [UIColor orangeScheme];
#define DO_BUTTON_TEXT_COLOR        [UIColor offWhiteScheme];
#define DO_CANCEL_TEXT_COLOR        [UIColor offWhiteScheme];
#define DO_DESTRUCTIVE_TEXT_COLOR   [UIColor offWhiteScheme];



#define DO_DIMMED_COLOR         DO_RGBA(0, 0, 0, 0.7)

#define DO_TITLE_FONT           [UIFont fontWithName:@"Avenir-Heavy" size:15]
#define DO_BUTTON_FONT          [UIFont fontWithName:@"Avenir-Medium" size:15]
